...
public class CRMessageMovL extends BaseMessage {
    ...
    public void constructSendData() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            this.messageContent=("MovL("+x+","+y+","+z+","+rx+","+ry+","+rz+")").getBytes(StandardCharsets.US_ASCII);
        }else
            this.messageContent=("MovL("+x+","+y+","+z+","+rx+","+ry+","+rz+")").getBytes( Charset.forName("US-ASCII"));
        this.messageStrContent=("MovL("+x+","+y+","+z+","+rx+","+ry+","+rz+")");
    }
