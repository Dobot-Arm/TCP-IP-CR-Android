...
public class CRMessageDOExecute extends BaseMessage {
    ...
    public void constructSendData() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            this.messageContent=("DOExecute("+index+","+status+")").getBytes(StandardCharsets.US_ASCII);
        }else
            this.messageContent=("DOExecute("+index+","+status+")").getBytes( Charset.forName("US-ASCII"));
        this.messageStrContent=("DOExecute("+index+","+status+")");
    }
