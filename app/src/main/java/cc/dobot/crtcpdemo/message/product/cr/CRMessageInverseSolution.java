...
public class CRMessageInverseSolution extends BaseMessage {
    double x,y,z,rx,ry,rz;

    @Override
    public void constructSendData() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            this.messageContent=("InverseSolution("+x+","+y+","+z+","+rx+","+ry+","+rz+")").getBytes(StandardCharsets.US_ASCII);
        }else
            this.messageContent=("InverseSolution("+x+","+y+","+z+","+rx+","+ry+","+rz+")").getBytes( Charset.forName("US-ASCII"));
        this.messageStrContent=("InverseSolution("+x+","+y+","+z+","+rx+","+ry+","+rz+")");
    }
