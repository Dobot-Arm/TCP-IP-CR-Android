...
public class CRMessageMovJIO extends BaseMessage {
    ...
    public void constructSendData() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            this.messageContent=("MovJIO("+x+","+y+","+z+","+rx+","+ry+","+rz+","+mode+","+distance+","+index+","+status+")").getBytes(StandardCharsets.US_ASCII);
        }else
            this.messageContent=("MovJIO("+x+","+y+","+z+","+rx+","+ry+","+rz+","+mode+","+distance+","+index+","+status+")").getBytes( Charset.forName("US-ASCII"));
        this.messageStrContent=("MovJIO("+x+","+y+","+z+","+rx+","+ry+","+rz+","+mode+","+distance+","+index+","+status+")");
    }
