...
public class CRMessageAO extends BaseMessage {
    ...
    public void constructSendData() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            this.messageContent=("AO("+index+","+value+")").getBytes(StandardCharsets.US_ASCII);
        }else
            this.messageContent=("AO("+index+","+value+")").getBytes( Charset.forName("US-ASCII"));
        this.messageStrContent=("AO("+index+","+value+")");
    }
