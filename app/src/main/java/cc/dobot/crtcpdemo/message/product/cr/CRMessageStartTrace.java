...
public class CRMessageStartTrace extends BaseMessage {

    private String traceName="";
    @Override
    public void constructSendData() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            this.messageContent=("StartTrace("+traceName+")").getBytes(StandardCharsets.US_ASCII);
        }else
            this.messageContent=("StartTrace("+traceName+")").getBytes( Charset.forName("US-ASCII"));
        this.messageStrContent=("StartTrace("+traceName+")");
    }
