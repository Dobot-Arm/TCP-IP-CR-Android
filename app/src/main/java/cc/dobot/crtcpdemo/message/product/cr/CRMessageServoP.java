...
public class CRMessageServoP extends BaseMessage {
    ...
    public void constructSendData() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            this.messageContent=("ServoP("+x+","+y+","+z+","+rx+","+ry+","+rz+")").getBytes(StandardCharsets.US_ASCII);
        }else
            this.messageContent=("ServoP("+x+","+y+","+z+","+rx+","+ry+","+rz+")").getBytes( Charset.forName("US-ASCII"));
        this.messageStrContent=("ServoP("+x+","+y+","+z+","+rx+","+ry+","+rz+")");
    }
